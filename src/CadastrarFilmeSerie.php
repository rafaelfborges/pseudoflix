...
if($pdo != null){
  try {
    ...
    $stmt = $pdo->prepare("INSERT INTO filmes_series(titulo, descricao, url_poster, url_imdb, 
                                      genero, data_lancamento, tipo, usuario_id, data_criacao)
                                      VALUES ('$titulo', '$descricao', '$urlPoster', '$urlImdb', '$genero', 
                                      '$dataLancamento', '$tipo', '$usuario_id', CURRENT_TIMESTAMP)");
