<?php
  ...
  if($pdo != null){
    try {
      ...
      if(isset($_GET['id'])) {
        $id = $_GET['id'];
        $sql = "SELECT favoritos.user_id, favoritos.movie_id, filmes_series.titulo, filmes_series.descricao, filmes_series.url_poster,
                        filmes_series.url_imdb, filmes_series.url_youtube, filmes_series.genero, 
